...
void VarRef::set_ref(const State &state, const string &block_name, unsigned int var_id)
{
	// convert block name to block id for faster access later.
	_block_id = state.find_block_id(block_name);
	_var_id = var_id;
}
